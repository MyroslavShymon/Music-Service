...
let AuthService = class AuthService {
    constructor(userService, tokenService, preferencesService) {
    ...
    async registration(dto, image) {
        ...
        const user = await this.userService.createUser(Object.assign(Object.assign({}, dto), { password: hashPassword }), image);
        await this.preferencesService.addPreference(user.id);
        return this.tokenService.generateToken(user);
    }
};
