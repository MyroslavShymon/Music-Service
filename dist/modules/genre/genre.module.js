...
GenreModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [genre_service_1.GenreService, file_service_1.FileService],
        imports: [
            typeorm_1.TypeOrmModule.forFeature([entities_1.Genre, entities_1.Answer, entities_1.AnswerToGenre]),
