...
const create_user_dto_1 = require("../../core/dtos/create-user.dto");
const user_service_1 = require("./user.service");
const change_user_dto_1 = require("./dtos/change-user.dto");
const role_dto_1 = require("./dtos/role.dto");
let UserController = class UserController {
    constructor(userService) {
        this.userService = userService;
    }
    create(userDto, image) {
        return this.userService.createUser(userDto, image);
    }
    addRole(roleDto, params) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, change_user_dto_1.ChangeUserDto]),
    __metadata("design:returntype", void 0)
