...
const add_products_to_basket_dto_1 = require("../../core/dtos/basket/add-products-to-basket.dto");
let BasketController = class BasketController {
    constructor(basketService) {
        this.basketService = basketService;
    }
    create(addProductsToBasketDto) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [add_products_to_basket_dto_1.AddProductsToBasketDto]),
